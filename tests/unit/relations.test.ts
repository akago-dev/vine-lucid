import { belongsToWithIdColumn } from "#akago_backend/lib/belong_to_with_id_column";
...
class Child extends AKNakedModel {
  static override excludeUpdate = ["childFieldA"];
...
test.group("Belongs to", async () => {
  class Parent extends AKNakedModel {
  ...
  test("Relation | mutability assignOnly | update | secondaryKey", async () => {
    class ChildSecondary extends AKNakedModel {
      static override excludeUpdate = ["childFieldA"];
      static override secondaryKey = "childFieldB";
    ...
    class ParentSecondary extends AKNakedModel {
      static override excludeUpdate = ["fieldA", "fieldC"];
      ...
      @VineModel(
        vine.lucid(ChildSecondary, { partial: true, null: true }),
        ChildSecondary,
      )
        ...
        child: vine
          .object({
            childFieldA: vine
              .string()
              .optional()
              .requiredIfAnyMissing(["childFieldB"]),
            childFieldB: vine
              .string()
              .optional()
              .requiredIfMissing("childFieldA"),
          })
          .nullable()
          .optional(),
      }),
...
test.group("Many to many", async () => {
  class Parent extends AKNakedModel {
    ...
    @VineModel(
      vine.array(vine.lucid(Child, { partial: true, null: true })),
      Child,
    )
    @manyToMany(() => Child)
  ...
  test("Relation | mutability assignOnly | update | secondaryKey", async () => {
    ...
    class ParentSecondary extends AKNakedModel {
      static override excludeUpdate = ["fieldA"];
