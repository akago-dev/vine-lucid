import { VineModelSchemasInstallers } from "#akago_backend/providers/vine_model_provider";
 ...
 * See `vine.lucid()`
 */
export function VineModel<
  VineSchema extends BaseLiteralType<any, any, any>,
